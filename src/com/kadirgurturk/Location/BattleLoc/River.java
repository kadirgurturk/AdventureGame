...
public class River extends BattleLoc{
    ...
    private final ArrayList<Ayı> obs ;
    ...
    public void combat() {
        ...
        while (getPlayer().getCharacter().getHealth() > 0 && obs.size() > 0){
            ...
            System.out.println(obs.size() + " kadar ayi kaldı. Saldirilan Ayinin Canı :" + obs.get(obs.size()- 1).getHealth());
            System.out.println("---------------------------");
        }
    ...
    public void Location() {
        System.out.println("-----------------------------");
        System.out.println("Gol Kenarindasın Buradaki " + obstacleNum + " tane ayıyı yenersen Su alabilirsin");
